...
1. 让多 agent 方案直接对齐现有 `ahe-coding-skills/ahe-*` 家族，而不是再维护一套平行命名体系。
...
| 当前组件 / 职责 | 形态 | 说明 |
| --- | --- | --- |
| `ahe-*` workflow family | workflow skills family | 整个 workflow 家族以扁平 `ahe-coding-skills/ahe-*` 目录存在 |
| `ahe-coding-skills/ahe-workflow-router/` | runtime router / 恢复编排 | canonical kernel；新请求识别与恢复入口（公开家族壳层见 `ahe-coding-skills/using-ahe-workflow/`） |
...
| `ahe-coding-skills/ahe-test-driven-dev/` | 实现入口 | 继续作为唯一实现入口 |
| `ahe-coding-skills/ahe-increment/` | 变更支线 skill | 负责变更支线推进 |
| `ahe-coding-skills/ahe-hotfix/` | 热修复支线 skill | 负责热修复支线推进 |
| `ahe-coding-skills/ahe-finalize/` | closeout 节点 | 当前现有 closeout 节点 |
| `ahe-coding-skills/ahe-bug-patterns/` / `ahe-coding-skills/ahe-test-review/` / `ahe-coding-skills/ahe-code-review/` | quality fan-out 首批并行节点 | 负责首批并行质量检查 |
...
- `ahe-coding-skills/ahe-design/`
- `ahe-coding-skills/ahe-tasks/`
- `ahe-coding-skills/ahe-test-driven-dev/`
- `ahe-coding-skills/ahe-increment/`
- `ahe-coding-skills/ahe-hotfix/`
- `ahe-coding-skills/ahe-finalize/`

### 3. 质量层 skills

这些 skill 负责 review / gate / traceability：

- `ahe-coding-skills/ahe-spec-review/`
- `ahe-coding-skills/ahe-design-review/`
- `ahe-coding-skills/ahe-tasks-review/`
- `ahe-coding-skills/ahe-bug-patterns/`
- `ahe-coding-skills/ahe-test-review/`
- `ahe-coding-skills/ahe-code-review/`
- `ahe-coding-skills/ahe-traceability-review/`
- `ahe-coding-skills/ahe-regression-gate/`
- `ahe-coding-skills/ahe-completion-gate/`
...
- **skills**：当前仓库真实存在、可被 agent 调用的 `ahe-coding-skills/ahe-*/SKILL.md`
