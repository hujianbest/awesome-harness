...
**Router-era 注：** 下文若出现 **legacy 合并入口/router** 旧称或 **legacy reroute 字段**，请按当前 **`ahe-workflow-router`** 与 **`reroute_via_router`** 理解；独立 pre-split 合并 skill 已移除。具体 token 映射见 `ahe-coding-skills/docs/ahe-workflow-shared-conventions.md`。
...
- `ahe-coding-skills/ahe-design/SKILL.md`
- `ahe-coding-skills/ahe-tasks/SKILL.md`

最小闭环优先改这四处，因为 router 决定 review 是否以 subagent 方式派发，而三个上游 producer 又天然形成“产出文档 -> review -> 真人确认 / 下一阶段”的明确链路。

### 第二批

- `ahe-coding-skills/ahe-spec-review/SKILL.md`
- `ahe-coding-skills/ahe-design-review/SKILL.md`
- `ahe-coding-skills/ahe-tasks-review/SKILL.md`
- `ahe-coding-skills/ahe-test-review/SKILL.md`
- `ahe-coding-skills/ahe-code-review/SKILL.md`
- `ahe-coding-skills/ahe-traceability-review/SKILL.md`

这批负责统一所有 reviewer skill 的 return contract、记录格式和回流语义。

### 第三批

- `ahe-coding-skills/ahe-test-driven-dev/SKILL.md`
- `ahe-coding-skills/ahe-hotfix/SKILL.md`
- `ahe-coding-skills/ahe-increment/SKILL.md`
- 质量门禁相关 skill
...
本方案主要参考了 `docs/references/skills_refer.md` 中以下几类实现：
